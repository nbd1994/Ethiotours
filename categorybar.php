...
<body>
    ...
    <form class="signForm" action="categoryBar.php" style="border:1px solid #ccc" enctype="multipart/form-data" method="post">
        <div class="container">
            ...
            <textarea name="package_desc" cols=70 rows="10"></textarea><br><br>
            ...
            <div class="clearfix">
                <button type="button" class="cancelbtn" onclick="window.location.href = 'booking.php'">Cancel</button>
